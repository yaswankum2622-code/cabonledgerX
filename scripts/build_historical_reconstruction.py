"""Build historical reconstruction outputs for CarbonLedgerX."""
...
def main() -> int:
    """Run the historical reconstruction build."""

    console.rule("[bold blue]CarbonLedgerX Historical Reconstruction[/bold blue]")
...
def build_summary_table(artifacts: list[object]) -> Table:
    """Render a readable summary table for history outputs."""

    table = Table(title="Historical Reconstruction Output Summary")
...
def print_assumptions(artifacts: list[object]) -> None:
    """Print core assumptions for the historical layer."""
